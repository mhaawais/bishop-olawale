  ...
  return (
    <section className="py-12 bg-black">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-myred">Explore my Latest Blogs</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="blog-card bg-gray-50 rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Exploring the Books</h3>
              ...
              <Link href="/detailblog/blog1" className="text-red-600 hover:text-red-800 font-medium">
                Read More →
              </Link>
            </div>
          </div>
          ...
          <div className="blog-card bg-gray-50 rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-gray-800">The Art Storytelling</h3>
              ...
              <Link href="/detailblog/blog2" className="text-red-600 hover:text-red-800 font-medium">
                Read More →
              </Link>
            </div>
          </div>
